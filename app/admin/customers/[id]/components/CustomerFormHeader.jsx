...
export default function CustomerFormHeader({ isEdit, customerName, onSave, isSaving }) {
  return (
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white">
            {isEdit ? customerName : "New Customer"}
          </h1>
          <p className="text-sm text-zinc-400">
            {isEdit ? "Edit customer details" : "Add a new customer"}
          </p>
        </div>
      </div>
      <button
